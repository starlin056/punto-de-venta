    ...
    <div class="card text-bg-light">
        <form action="{{ route('proveedores.update',['proveedore'=>$proveedore]) }}" method="post">
            ...
            <div class="card-header">
                <p>Tipo de proveedor: <span class="fw-bold">{{ strtoupper($proveedore->persona->tipo->value)}}</span></p>
            </div>
            <div class="card-body">
                ...
                <div class="row g-3">
                    ...
                    <!-------Razón social------->
                    <div class="col-12">
                        <label id="label-natural" for="razon_social" class="form-label">
                    ...
                    <!--------------email------->
                    <div class="col-md-6">
                        <x-forms.input id="email" type='email' labelText='Correo Eletronico' :defaultValue='$proveedore->persona->email' />
                    ...
                    <div class="col-md-6">
                        <x-forms.input id="telefono" type='number' :defaultValue='$proveedore->persona->telefono' />
