...
<div class="container-fluid px-4">
    <h1 class="mt-4 text-center">Crear Provedor</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="{{ route('panel') }}">Inicio</a></li>
        <li class="breadcrumb-item"><a href="{{ route('proveedores.index')}}">Provedor</a></li>
        ...
        <form action="{{ route('proveedores.store') }}" method="post">
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <!--------------email------->
                    <div class="col-md-6"> 
                        <x-forms.input id="email" type='email' labelText='Correo Eletronico' />
