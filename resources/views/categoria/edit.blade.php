...
<div class="container-fluid px-4">
    ...
    <x-forms.template :action="route('categorias.update',['categoria'=>$categoria])" method='post' patch='true'>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6">
                <x-forms.input id="nombre" :defaultvalue='$categoria->caracteristica->nombre' required='true'/>
            </div>

            <div class="col-12">
            <x-forms.textarea id="descripcion" :defaulvalue='$categoria->caracteristica->descripcion'/>
