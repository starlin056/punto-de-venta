            ...
            <div class="floating mb-8">
                <div class="relative inline-block">
                    ...
                    <div class="relative bg-white rounded-lg p-8 shadow-lg">
                        <h1 class="gradient-text text-9xl font-bold">404</h1>
                    </div>
                </div>
            </div>
            
            <h2 class="text-4xl font-bold mb-4 animate__animated animate__fadeIn text-gray-900">Página no encontrada</h2>
            <p class="text-xl text-gray-600 mb-8 animate__animated animate__fadeIn animate__delay-1s">
                La URL que estás buscando no está disponible o no existe.
            </p>
